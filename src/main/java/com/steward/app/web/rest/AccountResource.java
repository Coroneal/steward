...
import com.steward.app.domain.PersistentToken;
import com.steward.app.domain.User;
import com.steward.app.repository.PersistentTokenRepository;
import com.steward.app.repository.UserRepository;
import com.steward.app.security.SecurityUtils;
import com.steward.app.service.MailService;
import com.steward.app.service.UserService;
import com.steward.app.service.dto.UserDTO;
import com.steward.app.web.rest.vm.KeyAndPasswordVM;
import com.steward.app.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public ResponseEntity registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        return userRepository.findOneByLogin(managedUserVM.getLogin().toLowerCase())
            .map(user -> new ResponseEntity<>("login already exists", textPlainHeaders, HttpStatus.BAD_REQUEST))
            .orElseGet(() -> userRepository.findOneByEmail(managedUserVM.getEmail())
                .map(user -> new ResponseEntity<>("email address already exists", textPlainHeaders, HttpStatus.BAD_REQUEST))
                .orElseGet(() -> {
